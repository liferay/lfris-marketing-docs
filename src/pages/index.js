    ...
    return (
        <MainLayout className='home' location={location}>
            <section className="bg-primary-7">
                <h1 className="text-center">Welcome to Liferay Marketing Docs</h1>
                <p className="text-center color-neutral-4">All your marketing documentation needs in one place</p>
